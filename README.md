...
To configure a private or alternate container registry, the standard practice is to set the `docker.registry` option to point to the desired resistry in the `nextflow.config` file. For example:
